...
for i = 1:pocet_stanovisek
    ...
    for j = 1:length(ids)
        ...
        oprava = centrace_smeru(ss,st,st2,...
            smer_1*gon2rad, centr_1.smer*gon2rad, cil_1.smer*gon2rad, centr_1.delka, cil_1.delka, ...
            smer_2*gon2rad, centr_2.smer*gon2rad, cil_2.smer*gon2rad, centr_2.delka, cil_2.delka);
    ...
    if any(id_l) || any(id_p)
        ...
        for j = 1:gyro_azimut
            ...
            smer * gon2rad, cil_1.smer*gon2rad, centr_1.smer*gon2rad, centr_1.delka, cil_1.delka, ...
            delka_ss);

            oprava = centrace_smeru(ss,str2num(id_azimut),st,...
            deg2rad(gyro_cil{j}), deg2rad(gyro_uhel{j}),deg2rad(gyro_uhel{j}), gyro_delka{j}, gyro_delka{j}, ...
            smer * gon2rad,  centr_1.smer*gon2rad, cil_1.smer*gon2rad, centr_1.delka, cil_1.delka);
        ...
        oprava = centrace_smeru(ss,st,str2num(id_azimut),...
            smer * gon2rad, centr_1.smer*gon2rad,cil_1.smer*gon2rad, centr_1.delka, cil_1.delka, ...
            deg2rad(gyro_cil{j}),deg2rad(gyro_uhel{j}), deg2rad(gyro_uhel{j}), gyro_delka{j}, gyro_delka{j});
